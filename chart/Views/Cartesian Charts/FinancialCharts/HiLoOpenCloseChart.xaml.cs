...
namespace Syncfusion.ChartDemos.WinUI.Views
{
    ...
    /// </summary>
    public sealed partial class HiLoOpenCloseChart : Page, IDisposable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HiLoOpenCloseChart"/> page.
        /// </summary>
        public HiLoOpenCloseChart()
        {
            InitializeComponent();
        }
        ...
        private void DateTimeAxis_LabelCreated(object sender, UI.Xaml.Charts.ChartAxisLabelEventArgs e)
        {
