namespace Syncfusion.KanbanDemos.WinUI
{
    ...
    public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            DemoInfo columnRearrangement = new DemoInfo()
            {
                Name = "Column Rearrangement",
                Category = "Kanban",
                DemoType = DemoTypes.New,
                Description = "This example demonstrates column rearrangement in the Kanban control. You can drag the columns and drop them in any stage on the Kanban board.",
                DemoView = typeof(ColumnRearrangement),
                ShowInfoPanel = true
            };

            List<Documentation> columnRearrangementDocumentation = new List<Documentation>();
            columnRearrangementDocumentation.Add(new Documentation() { Content = "Kanban - API Reference Documentation", Uri = new Uri("https://help.syncfusion.com/cr/winui") });
            columnRearrangementDocumentation.Add(new Documentation() { Content = "Kanban - Documentation", Uri = new Uri("https://help.syncfusion.com/winui/overview") });

            columnRearrangement.Documentation.AddRange(columnRearrangementDocumentation);
