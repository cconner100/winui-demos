   ...
   public class SamplesConfiguration
    {
        public SamplesConfiguration()
        {
            ...
            DemoInfo aiFilterPredicate = new DemoInfo()
            {
                Name = "Smart Predicate Filtering",
                Category = "Filtering",
                DemoType = DemoTypes.AISamples,
                Description = "This sample demonstrates how to filter the DataGrid using natural language queries. The AI interprets these queries to generate precise column names and filter predicates.",
                DemoView = typeof(DataGrid.AIFilterPredicatesDemo),
                ShowInfoPanel = true
            };

            List<Documentation> aiFilterPredicateDocumentation = new List<Documentation>();
            aiFilterPredicateDocumentation.Add(new Documentation { Content = "DataGrid - AllowFiltering API Reference", Uri = new Uri("https://help.syncfusion.com/cr/winui/Syncfusion.UI.Xaml.DataGrid.SfDataGrid.html#Syncfusion_UI_Xaml_DataGrid_SfDataGrid_AllowFiltering") });
            aiFilterPredicateDocumentation.Add(new Documentation { Content = "DataGrid - Programmatic Filtering Documentation", Uri = new Uri("https://help.syncfusion.com/winui/datagrid/filtering#programmatic-filtering") });
            
            aiFilterPredicate.Documentation.AddRange(aiFilterPredicateDocumentation);
